...
describe('KiwiSort', () => {
  describe('ofAscending', () => {
    it('should create KiwiSort defaulted to ascending', () => {
      ...
      expect(sort).toEqual({ property: 'name', ascending: true, direction: 'ASC', ignoreCase: false});
    });
  });
  ...
  describe('ofDescending', () => {
    it('should create KiwiSort defaulted to descending', () => {
      ...
      expect(sort).toEqual({ property: 'name', ascending: false, direction: 'DESC', ignoreCase: false});
    });
  });
